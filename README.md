...
Наведи мышь на пузырь — он лопнет. Поведение зависит от типа пузыря:

- **Пустой пузырь** — просто гаснет: прозрачность быстро снижается до нуля, пузырь исчезает без следа
- **Пузырь с рыбками** — взрывается на 12–20 мелких осколков-пузырьков, которые разлетаются в стороны и вверх, постепенно таяя
...
**Ctrl + G + Enter** — единственный способ закрыть программу (удерживайте Ctrl и G одновременно, затем нажмите Enter). Все остальные системные комбинации заблокированы:
