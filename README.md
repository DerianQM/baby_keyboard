...
| Клавиши | Действие |
|---|---|
| **Пробел** | Раковина открывается и улыбается (то же самое, что клик мышкой по раковине) |
| **Ctrl + G** | Очистить весь набранный текст |
| **Ctrl + G + F7 + Enter** | Выход из программы |
...
Программа откроется в полноэкранном режиме. Для выхода нажмите **Ctrl + G + F7 + Enter**.
